...
namespace UI_DSM.Shared.Search.SearchDto
{
	...
	/// <summary>
	/// The <see cref="Role" /> is the <see cref="ISearchDto" /> for the Poco of the same name
	/// </summary>
	[SearchDto(nameof(Role))]
	public partial class Role : BaseSearchDto
	{

		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="RoleName"/>
		/// </summary>
		public string RoleName { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="List<string>"/> <see cref="AccessRights"/>
		/// </summary>
