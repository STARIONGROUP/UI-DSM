...
namespace UI_DSM.Shared.Search.SearchDto
{
	...
	/// <summary>
	/// The <see cref="ReviewTask" /> is the <see cref="ISearchDto" /> for the Poco of the same name
	/// </summary>
	[SearchDto(nameof(ReviewTask))]
	public partial class ReviewTask : BaseSearchDto
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="int"/> <see cref="TaskNumber"/>
		/// </summary>
		public int TaskNumber { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="MainView"/>
		/// </summary>
		public string MainView { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="OptionalView"/>
		/// </summary>
		public string OptionalView { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="AdditionalView"/>
		/// </summary>
		public string AdditionalView { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="bool"/> <see cref="HasPrimaryView"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="Participant"/> <see cref="IsAssignedTo"/>
		/// </summary>
