...
namespace UI_DSM.Shared.Search.SearchDto
{
	...
	/// <summary>
	/// The <see cref="UserEntity" /> is the <see cref="ISearchDto" /> for the Poco of the same name
	/// </summary>
	[SearchDto(nameof(UserEntity))]
	public partial class UserEntity : BaseSearchDto
	{

		/// <summary>
		/// Gets or sets the <see cref="Guid"/> <see cref="User"/>
		/// </summary>
		public Guid User { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="UserId"/>
		/// </summary>
		public string UserId { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="UserName"/>
		/// </summary>
		public string UserName { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="bool"/> <see cref="IsAdmin"/>
		/// </summary>
