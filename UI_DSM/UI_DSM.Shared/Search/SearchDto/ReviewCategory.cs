...
namespace UI_DSM.Shared.Search.SearchDto
{
	...
	/// <summary>
	/// The <see cref="ReviewCategory" /> is the <see cref="ISearchDto" /> for the Poco of the same name
	/// </summary>
	[SearchDto(nameof(ReviewCategory))]
	public partial class ReviewCategory : BaseSearchDto
	{

		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="ReviewCategoryName"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="TagColor"/>
		/// </summary>
		public string TagColor { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="List<Project>"/> <see cref="Projects"/>
		/// </summary>
		public List<Project> Projects { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="List<ReviewObjective>"/> <see cref="ReviewObjectives"/>
		/// </summary>
		public List<ReviewObjective> ReviewObjectives { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="List<ReviewItem>"/> <see cref="ReviewItems"/>
		/// </summary>
