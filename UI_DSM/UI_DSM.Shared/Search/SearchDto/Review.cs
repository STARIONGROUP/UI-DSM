...
namespace UI_DSM.Shared.Search.SearchDto
{
	...
	/// <summary>
	/// The <see cref="Review" /> is the <see cref="ISearchDto" /> for the Poco of the same name
	/// </summary>
	[SearchDto(nameof(Review))]
	public partial class Review : BaseSearchDto
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="int"/> <see cref="ReviewNumber"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="List<Artifact>"/> <see cref="Artifacts"/>
		/// </summary>
