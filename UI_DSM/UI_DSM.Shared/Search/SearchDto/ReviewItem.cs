...
namespace UI_DSM.Shared.Search.SearchDto
{
	...
	/// <summary>
	/// The <see cref="ReviewItem" /> is the <see cref="ISearchDto" /> for the Poco of the same name
	/// </summary>
	[SearchDto(nameof(ReviewItem))]
	public partial class ReviewItem : AnnotatableItem
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="Guid"/> <see cref="ThingId"/>
		/// </summary>
