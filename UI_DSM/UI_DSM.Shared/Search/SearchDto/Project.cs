...
namespace UI_DSM.Shared.Search.SearchDto
{
	...
	/// <summary>
	/// The <see cref="Project" /> is the <see cref="ISearchDto" /> for the Poco of the same name
	/// </summary>
	[SearchDto(nameof(Project))]
	public partial class Project : BaseSearchDto
	{

		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="ProjectName"/>
		/// </summary>
		public string ProjectName { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="List<Participant>"/> <see cref="Participants"/>
		/// </summary>
