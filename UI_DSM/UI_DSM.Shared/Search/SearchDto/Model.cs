...
namespace UI_DSM.Shared.Search.SearchDto
{
	...
	/// <summary>
	/// The <see cref="Model" /> is the <see cref="ISearchDto" /> for the Poco of the same name
	/// </summary>
	[SearchDto(nameof(Model))]
	public partial class Model : Artifact
	{

		/// <summary>
		/// Gets or sets the <see cref="string"/> <see cref="ModelName"/>
		/// </summary>
		public string ModelName { get; set; }

		/// <summary>
		/// Gets or sets the <see cref="Guid"/> <see cref="IterationId"/>
		/// </summary>
