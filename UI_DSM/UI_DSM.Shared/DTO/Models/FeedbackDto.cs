// --------------------------------------------------------------------------------------------------------
// <copyright file="FeedbackDto.cs" company="RHEA System S.A.">
...
namespace UI_DSM.Shared.DTO.Models
{
    ...
    /// </summary>
    public class FeedbackDto : AnnotationDto
    {
        /// <summary>
        ///     Initiazes a new <see cref="FeedbackDto" />
        /// </summary>
        public FeedbackDto()
        {
        }
        ...
        ///     Initiazes a new <see cref="FeedbackDto" />
        /// </summary>
        /// <param name="id">The <see cref="Guid" /> of the represented <see cref="FeedbackDto" /></param>
