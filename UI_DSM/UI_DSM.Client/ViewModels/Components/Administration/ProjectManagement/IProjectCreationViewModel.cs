// --------------------------------------------------------------------------------------------------------
// <copyright file="IProjectCreationViewModel.cs" company="RHEA System S.A.">
...
namespace UI_DSM.Client.ViewModels.Components.Administration.ProjectManagement
{
    ...
    /// <summary>
    ///     Interface definition for <see cref="ProjectCreationViewModel" />
    /// </summary>
    public interface IProjectCreationViewModel
    {
        /// <summary>
