...
namespace UI_DSM.Client.ViewModels.Components.NormalUser.Views.RowViewModel
{
    ...
    /// </summary>
    public abstract class ElementDefinitionRowViewModel: HaveThingRowViewModel<ElementDefinition>
    {
        /// <summary>
        ...
        protected ElementDefinitionRowViewModel(ElementDefinition thing, ReviewItem reviewItem) : base(thing, reviewItem)
        {
        }
