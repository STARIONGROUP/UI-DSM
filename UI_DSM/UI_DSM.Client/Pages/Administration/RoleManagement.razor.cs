// --------------------------------------------------------------------------------------------------------
// <copyright file="RoleManagement.razor.cs" company="RHEA System S.A.">
...
namespace UI_DSM.Client.Pages.Administration
{
    ...
    /// <summary>
    ///     This page enable the Administrator to manage all <see cref="Role" />
    /// </summary>
    public partial class RoleManagement : IDisposable
    {
        ...
        /// <summary>
        ///     The <see cref="IRoleManagementViewModel" />
        /// </summary>
        [Inject]
        public IRoleManagementViewModel ViewModel { get; set; }
