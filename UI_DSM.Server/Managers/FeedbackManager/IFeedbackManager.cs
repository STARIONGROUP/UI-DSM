// --------------------------------------------------------------------------------------------------------
// <copyright file="IFeedbackManager.cs" company="RHEA System S.A.">
...
namespace UI_DSM.Server.Managers.FeedbackManager
{
    ...
    /// <summary>
    ///     Interface definition for <see cref="FeedbackManager" />
    /// </summary>
    public interface IFeedbackManager : IContainedEntityManager<Feedback>
    {
        /// <summary>
