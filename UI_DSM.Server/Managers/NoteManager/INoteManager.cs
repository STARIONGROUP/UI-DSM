// --------------------------------------------------------------------------------------------------------
// <copyright file="INoteManager.cs" company="RHEA System S.A.">
...
namespace UI_DSM.Server.Managers.NoteManager
{
    ...
    /// <summary>
    ///     Interface definition for <see cref="NoteManager" />
    /// </summary>
    public interface INoteManager : IContainedEntityManager<Note>
    {
        /// <summary>
