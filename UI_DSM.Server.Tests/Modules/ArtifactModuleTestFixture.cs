...
namespace UI_DSM.Server.Tests.Modules
{
    ...
    public class ArtifactModuleTestFixture
    {
        ...
        public async Task VerifyCreateEntity()
        {
            ...
            await this.module.CreateEntity(this.artifactManager.Object, modelDto, this.searchService.Object, this.context.Object);
            this.response.VerifySet(x => x.StatusCode=404, Times.Once);
        ...
        public async Task VerifyUpdateAndDeleteEntity()
        {
            ...
            await this.module.UpdateEntity(this.artifactManager.Object, dto.Id, dto, this.searchService.Object, this.context.Object);
            await this.module.DeleteEntity(this.artifactManager.Object, dto.Id, this.searchService.Object, this.context.Object);
