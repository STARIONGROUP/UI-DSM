...
namespace UI_DSM.Server.Tests.Modules
{
    ...
    public class ReviewModuleTestFixture
    {
        ...
        public async Task VerifyCreateEntity()
        {
            ...
            await this.module.CreateEntity(this.reviewManager.Object, dto, this.searchService.Object, this.context.Object);
        ...
        public async Task VerifyDeleteEntity()
        {
            ...
            await this.module.DeleteEntity(this.reviewManager.Object, review.Id, this.searchService.Object, this.context.Object);
            this.response.VerifySet(x => x.StatusCode = 401, Times.Once);
            ...
            var deleteResult = await this.module.DeleteEntity(this.reviewManager.Object, review.Id, this.searchService.Object, this.context.Object);
        ...
        public async Task VerifyUpdateEntity()
        {
            ...
            await this.module.UpdateEntity(this.reviewManager.Object, review.Id, reviewDto, this.searchService.Object, this.context.Object);
            this.response.VerifySet(x => x.StatusCode = 401, Times.Once);
        ...
        public async Task VerifyGetOpenTasksAndComments()
        {
            ...
            this.reviewManager.As<IReviewManager>().Setup(x => x.GetOpenTasksAndComments(It.IsAny<IEnumerable<Guid>>(), project.Id, "user")).ReturnsAsync(result);
            await this.module.GetOpenTasksAndComments(this.reviewManager.As<IReviewManager>().Object,project.Id, this.context.Object);
            this.reviewManager.As<IReviewManager>().Verify(x => x.GetOpenTasksAndComments(It.IsAny<IEnumerable<Guid>>(), project.Id, "user"), Times.Once);
        }
    }
}
