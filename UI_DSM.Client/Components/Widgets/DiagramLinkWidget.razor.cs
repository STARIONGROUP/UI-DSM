...
namespace UI_DSM.Client.Components.Widgets
{
    ...
    public partial class DiagramLinkWidget
    {
        ...
        /// <summary>
        ///     Gets the color of the interface, which depends on the <see cref="Category" />
        /// </summary>
        public string Color => this.Link.HasComments ? "green" : this.Link.InterfaceCategory.ToColorString();
