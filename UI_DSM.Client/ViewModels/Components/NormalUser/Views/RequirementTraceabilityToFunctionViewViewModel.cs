...
namespace UI_DSM.Client.ViewModels.Components.NormalUser.Views
{
    ...
    public class RequirementTraceabilityToFunctionViewViewModel : HaveTraceabilityTableViewModel, IRequirementTraceabilityToFunctionViewViewModel
    {
        ...
        /// </summary>
        protected override string HeaderName => "source func/target req";
        ...
        {
            FilterElementBaseRows(selectedFilters, this.TraceabilityTableViewModel.Rows.OfType<FunctionRowViewModel>());
        }
